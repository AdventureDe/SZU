(function() {
	var h = {},
		mt = {},
		c = {
			id: "9ef7debb81babe8b94af7f2c274869fd",
			dm: ["vivo.com.cn"],
			...
			icon: '',
			ctrk: [
				"%5b%22http%3a%5c%2f%5c%2fvivo.com.cn%5c%2fproduct.html%22%2c%22https%3a%5c%2f%5c%2fshopact.vivo.com.cn%5c%2fpage%5c%2fvivo20181111%22%2c%22https%3a%5c%2f%5c%2fmshopact.vivo.com.cn%5c%2fpage%5c%2fvivo20181111%22%2c%22http%3a%5c%2f%5c%2fvivo.com.cn%22%2c%22http%3a%5c%2f%5c%2fshop.vivo.com.cn%22%2c%22https%3a%5c%2f%5c%2fshopact.vivo.com.cn%5c%2fpage%5c%2frecycle%22%2c%22https%3a%5c%2f%5c%2fmshopact.vivo.com.cn%5c%2fpage%5c%2frecycle%22%5d"],
			vdur: 1800000,
			age: 31536000000,
			qiao: 0,
			pt: 0,
			spa: 0,
			aet: '',
			hca: '388BF4D002FA6605',
			ab: '0',
			v: 1,
			brd: 'VvIOJexroG3WeY7Jsjk1ulFoBgKK0gOTDYrEOwXPsp3LGJLVYZkhEG0PtDcVefKhyWj6ogKK3gOTH4PF_2uxOjjg8UtVJeC6EG0Ptf8g0M5'
		};
	var s = void 0,
		t = !0,
		u = null,
	...
	mt.cookie.set = function(e, a, b) {
		...
		document.cookie = e + "=" + a + (b.domain ? "; domain=" + b.domain : "") + (b.path ? "; path=" + b
			.path : "") + (k ? "; expires=" + k.toGMTString() : "") + (b.ec ? "; secure" : "")
	};
	...
	mt.event.c = function(e, a, b, k) {
		e.addEventListener ? e.addEventListener(a, b, k || x) : e.attachEvent && e.attachEvent("on" + a,
			function(d) {
				b.call(e, d)
			})
	};
	(function() {
		...
		mt.lang.$b = function(a, b) {
			...
			var d = "00000000000000000000000000000000",
				f = k(a),
				g = k(b);
			return parseInt((d + ((f[0] | g[0]) >>> 0).toString(2)).slice(-32) + (d + ((f[1] | g[1]) >>> 0)
				.toString(2)).slice(-32), 2)
		};
	...
	(function() {
		...
		mt.d.Wb = function(b) {
			...
			try {
				...
				for (var k = b.split(">"), d = document.body, a = k.length - 1; 0 <= a; a--)
					if (-1 < k[a].indexOf("#")) {
						var g = k[a].split("#")[1];
						(d = document.getElementById(g)) || (d = document.getElementById(decodeURIComponent(
							g)));
					...
					if (!("html" === l || "body" === l)) {
						...
						for (p = 0; p < d.childNodes.length; p++) 1 === d.childNodes[p].nodeType && d
							.childNodes[p].nodeName.toLowerCase() === l && g.push(d.childNodes[p]);
						if (!g[a]) return u;
						d = g[a]
					}
					b++
		...
		mt.d.fa = function(b, a) {
			...
			for (; b.parentNode != u;) {
				...
				if ((e = "" !== b.id) && a) {
					...
					break
				} else e && (e = "#" + encodeURIComponent(b.id), e = 0 < d.length ? e + ">" + d.join(">") :
					e, f.push(e)), d.unshift(encodeURIComponent(String(b.nodeName).toLowerCase()) + (1 <
					g ? "[" + l + "]" : ""));
				b = b.parentNode
			}
			f.push(d.join(">"));
		...
		mt.d.hc = function(b, a) {
			if (b)
				for (var d = b.childNodes, f = 0, g = d.length; f < g; f++) {
					var e = d[f];
					if (e && 3 === e.nodeType) return d = e.textContent || e.innerText || e.nodeValue || "",
						e.textContent ? e.textContent = a : e.innerText ? e.innerText = a : e
						.nodeValue = a, d
				}
		};
		mt.d.gc = function(b, a) {
			...
			var d = {};
			a = a || {};
			for (var f in a) a.hasOwnProperty(f) && a[f] !== s && (d[f] = b.getAttribute(f) || "", b
				.setAttribute(f, a[f]));
			return d
		};
		mt.d.getAttribute = function(b,
			...
			if (!d && b.attributes && b.attributes.length)
				for (var f = b.attributes, e = f.length, l = 0; l < e; l++) f[l].nodeName === a && (d = f[l]
					.nodeValue);
			return d
		};
		mt.d.Qa = function(b) {
		...
		mt.d.Vb = function(b, k) {
			...
			e.Z(b) && 0 === String(b).indexOf("!HMCQ!") ? (d =
				String(b), d = a.f(document.location.href, d.substring(6, d.length))) : e.Z(b) || (d =
				mt.d.Qa(b), "input" === d && k && ("button" === b.type || "submit" === b.type) ? d = e
				.trim(b.value) || "" : "input" === d && !k && "password" !== b.type ? d = e.trim(b
					.value) || "" : "img" === d ? (d = mt.d.getAttribute, d = d(b, "alt") || d(b,
					"title") || d(b, "src")) : d = "body" === d || "html" === d ? [
					"(hm-default-content-for-", d, ")"
				].join("") : mt.d.Za(b));
	...
	(function() {
		...
		mt.e.$a = function() {
			var a = document;
			return parseInt(window.innerHeight || a.documentElement.clientHeight || a.body && a.body
				.clientHeight || 0, 10)
		};
		mt.e.W = function() {
		...
		mt.e.bb = function() {
			var a = document;
			return parseInt(window.innerWidth || a.documentElement.clientWidth || a.body.offsetWidth || 0,
				10)
		};
		mt.e.orientation = 0;
		(function() {
		...
		return function(b) {
			switch (typeof b) {
				...
				default:
					...
					if (b instanceof Date) return '"' + b.getFullYear() + "-" + a(b.getMonth() + 1) + "-" +
						a(b.getDate()) + "T" + a(b.getHours()) + ":" + a(b.getMinutes()) + ":" + a(b
							.getSeconds()) + '"';
					g = ["{"];
					l = mt.w.stringify;
					for (f in b)
	...
	mt.localStorage.Q = function() {
		if (!mt.localStorage.g) try {
			mt.localStorage.g = document.createElement("input"), mt.localStorage.g.type = "hidden", mt
				.localStorage.g.style.display = "none", mt.localStorage.g.addBehavior("#default#userData"),
	...
	mt.localStorage.set = function(e, a, b) {
		...
		try {
			window.localStorage ? (a = k.getTime() + "|" + a, window.localStorage.setItem(e, a)) : mt
				.localStorage.Q() && (mt.localStorage.g.expires = k.toUTCString(), mt.localStorage.g.load(
						document.location.hostname), mt.localStorage.g.setAttribute(e, a), mt.localStorage.g
					.save(document.location.hostname))
		} catch (d) {}
	};
	...
	mt.localStorage.remove = function(e) {
		if (window.localStorage) window.localStorage.removeItem(e);
			...
			mt.localStorage.g.load(document.location.hostname), mt.localStorage.g.removeAttribute(e), mt
				.localStorage.g.save(document.location.hostname)
		} catch (a) {}
	};
	mt.sessionStorage = {};
	...
	(function() {
		...
		mt.A.wa = function(a) {
			function b(a) {
				var b = [],
					d;
				for (d in a) a.hasOwnProperty(d) && b.push(encodeURIComponent(d) + "=" + encodeURIComponent(
					a[d]));
				return b.join("&")
			}
			...
			try {
				...
				"GET" === g && (d && (f += (0 <= f.indexOf("?") ? "&" : "?") + d,
					d = u), p && (f += (0 <= f.indexOf("?") ? "&" : "?") + "b" + +new Date + "=1"));m.open(
					g, f, t);m.onreadystatechange = function() {
					if (4 === m.readyState) {
						var a = 0;
						try {
							a = m.status
				...
				for (var w in l) l.hasOwnProperty(w) && m.setRequestHeader(w, l[w]);n && (m
					.withCredentials = t);r && (q = setTimeout(function() {
		...
		var e = mt.lang,
			...
			b = {
				...
				ma: function(b, d, f) {
					...
					return RegExp("^" + d.replace(/[?.+^${}()|[\]\\]/g, "\\$&").replace(/\*/g, ".*") + "$")
						.test(b)
				},
				H: function(a, d) {
					var f = b.Oa(a);
	...
	(function() {
		function e(b, e) {
			...
			a.j(e) && (d.readyState ? d.onreadystatechange = function() {
				if ("loaded" === d.readyState || "complete" === d.readyState) d.onreadystatechange = u,
					e()
			} : d.onload = function() {
				e()
			});
			...
			a = {
				D: function() {
					if ("" !== c.icon) {
						...
						document.write("swf" === a[1] || "gif" === a[1] ? '<a href="' + k +
							'" target="_blank"><img border="0" src="' + d + '" width="' + a[2] +
							'" height="' + a[3] + '"></a>' : '<a href="' + k + '" target="_blank">' + a[
								0] + "</a>")
					}
				}
			};
	...
	(function() {
		var e = mt.lang,
			...
			k = {
				...
				qa: function(a, b) {
					for (var g = {}, l = String(b).split(">").length, k = 0; k < l; k++) g[b] = "", /\[1\]$/
						.test(b) && (g[b.substring(0, b.lastIndexOf("["))] = ""), /\]$/.test(b) ||
				...
				ua: function() {
					...
					if (!document.addEventListener)
						for (var f = b.H(c.etrk) || [], g = 0; g < f.length; g++) {
							var l = f[g]; - 1 === l.indexOf(">") && (0 === l.indexOf("#") && (l = l
								.substring(1)), (l = e.La(l)) && a.c(l, "click", k.zb(d), t))
						}
				},
				ba: function(a) {
	...
	(function() {
		var e = mt.d,
			...
			l = {
				ta: function() {
					c.ctrk && 0 < c.ctrk.length && (b.c(document, "mouseup", l.Ca()), b.c(window, "unload",
						function() {
							l.M()
				...
				Ca: function() {
					return function(a) {
						if (f.H(c.ctrk, t) && (a = l.Na(a), "" !== a)) {
							var b = (d.L + "//" + d.aa + "?" + h.b.pa().replace(/ep=[^&]*/, "ep=" +
								encodeURIComponent(a))).length;
							b + (d.G + "").length > d.ca || (b + encodeURIComponent(g.join("!") + (g
									.length ? "!" : "")).length + (d.G + "").length > d.ca && l.M(),
								g.push(a),
				...
				Na: function(b) {
					var d = b.target || b.srcElement,
						f, m;
					k.mb ? (m = Math.max(document.documentElement.scrollTop, document.body.scrollTop), f =
						Math.max(document.documentElement.scrollLeft, document.body.scrollLeft), f = b
						.clientX + f, m = b.clientY + m) : (f = b.pageX, m = b.pageY);
					b = l.Ta(b, d, f, m);
					var q = window.innerWidth || document.documentElement.clientWidth || document.body
						.offsetWidth;
					switch (c.align) {
						case 1:
							f -= q / 2;
					...
					q.push(b.Nb);
					q.push(b.cb);
					(d = "a" === (d.tagName || "").toLowerCase() ? d : e.Ma(d)) ? (q.push("a"), q.push(a.n(
						encodeURIComponent(d.href)))) : q.push("b");
					return q.join("*")
				},
				Ta: function(b, d, f, m) {
					b = e.Xa(d);
					var q = 0,
						...
						w = 0,
						l = 0;
					if (d && (q = d.offsetWidth || d.clientWidth, g = d.offsetHeight || d.clientHeight, l =
							e.Ua(d), w = l.left, l = l.top, a.j(d.getBBox) && (g = d.getBBox(), q = g.width,
								g = g.height), "html" === (d.tagName || "").toLowerCase())) q = Math.max(q,
						d.clientWidth), g = Math.max(g, d.clientHeight);
					return {
						ub: Math.round(100 *
							((f - w) / q)),
	...
	(function() {
		...
		function k(b) {
			if (!("focus" == b.type || "blur" == b.type) || !(b.target && b.target != window)) p = "focus" == b
				.type || "focusin" == b.type ? t : x, a()
		}
		var d = mt.event,
			f = h.s,
			g = t,
		...
		(function() {
			...
			"object" == typeof document.onfocusin ? (d.c(document, "focusin", k), d.c(document, "focusout",
				k)) : (d.c(window, "focus", k), d.c(window, "blur",
				k))
		})();
		h.T = {
			Va: function() {
			...
			d = {
				lb: function(d) {
					if ((window._dxt === s || e.i(window._dxt, "Array")) && "undefined" !== typeof h.b) {
						var g = k.I();
						b([a.protocol, "//datax.baidu.com/x.js?si=", c.id, "&dm=", encodeURIComponent(g)]
							.join(""), d)
					}
				},
				Gb: function(b) {
					if (e.i(b, "String") || e.i(b, "Number")) window._dxt = window._dxt || [], window._dxt
						.push(["_setUserId", b])
				}
			};
		return h.Fa = d
			...
			n = {
					...
					if (!a || b.i(a, "Array")) window._hmt = {
						...
						push: function() {
							for (var a =
								...
								var e = arguments[d];
								b.i(e, "Array") && (a.cmd[a.id].push(e), "_setAccount" === e[0] && (
									1 < e.length && /^[0-9a-f]{31,32}$/.test(e[1])) && (e =
									e[1], a.id = e, a.cmd[e] = a.cmd[e] || []))
							}
						}
				...
				Ja: function() {
					...
					if (b && b.cmd && b.cmd[c.id])
						for (var a = b.cmd[c.id], d = /^_track(Event|Order)$/, e = 0, f = a.length; e <
							f; e++) {
							var g = a[e];
				...
				_trackPageview: function(b) {
					1 < b.length && (b[1].charAt && "/" === b[1].charAt(0)) && (n.h |= 4, h.b.a.sn = h.b
						.ea(), h.b.a.et = 0, h.b.a.ep = "", h.b.a.vl = d.W(), n.Y || (h.b.a.su = h.b.a
							.u || document.location.href), h.b.a.u = f.protocol + "//" + document
						.location.host +
						b[1], h.b.m(), h.b.sb = +new Date)
				},
				_trackEvent: function(a) {
					2 < a.length && (n.h |= 8, h.b.a.et = 4, h.b.a.ep = b.n(a[1]) + "*" + b.n(a[2]) + (a[
						3] ? "*" + b.n(a[3]) : "") + (a[4] ? "*" + b.n(a[4]) : ""), h.b.m())
				},
				...
				_setReferrerOverride: function(a) {
					1 < a.length && (a = a[1], b.i(a, "String") ? (h.b.a.su = "/" === a.charAt(0) ? f
						.protocol + "//" + window.location.host + a : a, n.Y = t) : n.Y = x)
				},
				...
				_providePlugin: function(a) {
					if (1 < a.length) {
						var d = window._hmt,
							e = a[1];
						a = a[2];
						if (b.X(f.na, e) && b.j(a) && (d.plugins = d.plugins || {}, d.z = d.z || {}, d
								.plugins[e] = a, d.l = d.l || [], a = d.l.slice(), e && a.length && a[0][
								1] === e))
				...
				_requirePlugin: function(a) {
					if (1 <
						...
						var d = window._hmt,
							...
							g = a[2] || {};
						if (b.X(f.na, e))
							if (d.plugins = d.plugins || {}, d.z = d.z || {}, d.plugins[e] && !d.z[e]) d.z[
								e] = new d.plugins[e](g);
							else {
								d.l = d.l || [];
	...
	(function() {
		var e = h.s;
		c.spa !== s && "1" === String(c.spa) && (window._hmt = window._hmt || [], window._hmt.push([
			"_requirePlugin", "UrlChangeTracker"
		]), e.c("pv-b", function() {
	...
	(function() {
		function e() {
			"undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = t, this
				.a = {}, this.ob = this.ia = this.ha = t, this.ga = m.ga, this.Tb = k.Z(c.aet) && 0 < c.aet
				.length ? c.aet.split(",") : "", this.D())
		}
		var a = mt.url,
			b = mt.A,
			k = mt.lang,
		...
		e.prototype = {
			...
			Eb: function() {
				...
				this.nb() ? (p.setData("Hm_lvt_" + c.id, f, c.age), p.setData("Hm_lpvt_" + c.id, m.B),
			...
			da: function() {
				for (var a = document.cookie.split(";"), b = 0; b < a.length; b++) {
					var d = a[b].split("=");
					d.length && /Hm_(up|cv|lp?vt)_[0-9a-f]{31}/.test(String(d[0])) && p.removeData(k
						.trim(d[0]));
			...
			D: function() {
				try {
					this.Aa(), this.Fb(), this.Cb(), h.b = this, this.za(), this.tb(), v.k("pv-b"), this
						.ob && this.Bb()
				} catch (a) {
					var d = [];
					d.push("si=" + c.id);
			...
			Bb: function() {
				...
				this.ha ? (this.a.et = 0, this.a.ep = "", v.k("setPageviewProp"), this.a.vl = f.W(),
					this.m(a), this.a.p = "") : a();
				this.sb = +new Date;
					...
					if (window.postMessage && window.self !== window.parent) {
						...
						r.c(window, "message", function(d) {
							if (a.V(d.origin) === m.Hb) {
								...
								if (RegExp(c.id).test(d.sd || "") && f) b.a.rnd = Math.round(
									Math.random() * m.G), q(m.protocol + "//" + c.js + e +
									".js?" + b.a.rnd)
							}
						});
			...
			tb: function() {
				try {
					if (window.self ===
						...
						/^[a-f0-9]{32}\/?$/.test(d) && /^(overlay|vabtest)\/?$/.test(e) && q(m
							.protocol + "//" + c.js + e + ".js?" + Math.round(Math.random() * m.G))
					}
				} catch (f) {}
			},
			va: function(a) {
	...
	var F = h.load;
	if (c.qiao) {
		for (var G = ["https://goutong.baidu.com/site/"], H = c.id, I = 5381, J = H.length, K = 0; K < J; K++) I = (
			33 * I + Number(H.charCodeAt(K))) % 4294967296;
